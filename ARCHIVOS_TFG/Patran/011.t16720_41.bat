...
set MSC_AUTH=edu
set MSC_BASE=d:/program files/mscnastran/nastran
set MSC_DBS=d:/scratch/011.T16720_41
...
if exist "%sdirnt%\011.T16720_41.perf" "d:/program files/mscnastran/nastran/bin/msc20191" mscsystem %sdirnt%\011.T16720_41.perf >> %lognt%
@rem
set /a f98 = 0
call :get_file_size  "%sdirnt%\011.T16720_41.f98"
if /i %FILE_SIZE% gtr 0 set /a f98 = 1
set /a f99 = 0
call :get_file_size  "%sdirnt%\011.T16720_41.f99"
...
if /i %i% neq 0 (
   ...
   if "%ferr%" == "" (
      if /i %f98% neq 0 (
         if /i %f99% neq 0 copy /f /y "%sdirnt%\011.T16720_41.f99"+"%sdirnt%\011.T16720_41.f98" "%outnt%.acms_out"
         if /i %f99% equ 0 copy /f /y "%sdirnt%\011.T16720_41.f98" "%outnt%.acms_out"
      ) else (
         copy /f /y "%sdirnt%\011.T16720_41.f99" "%outnt%.acms_out"
      )
   )
)
@rem
...
for %%f in ("%sdirnt%\011.T16720_41.*") do call :delete_job_file "%%f"
